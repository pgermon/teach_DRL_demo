    ...
    def get_object_from_arguments(args, env_f, teacher):
        ...
        if "sac" in args.student:
            ...
            if args.student == "sac_v0.1.1":
                if args.backend == "tf1":
                    from ACL_bench.students.spinup import sac_011_tf1 as sac
                ...
                if args.backend == "tf1":
                    from ACL_bench.students.spinup import sac_02_tf1 as sac
                elif args.backend == "pytorch":
                    from ACL_bench.students.spinup import sac_02_pytorch as sac
