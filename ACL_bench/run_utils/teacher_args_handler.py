...
import numpy as np
from ACL_bench.run_utils.expert_trajectories import load_expert_trajectory, load_human_expert_trajectory
from ACL_bench.teachers.teacher_controller import TeacherController
from ACL_bench.teachers.utils.alpha_functions import PercentageAlphaFunction
...
class TeacherArgsHandler(AbstractArgsHandler):
    ...
    def set_parser_arguments(parser):
        parser.add_argument('--teacher', type=str, default="ALP-GMM")  # ALP-GMM, Covar-GMM, RIAC, Oracle, Random, ADR
        parser.add_argument('--test_set', type=str, default=None)
        parser.add_argument('--allow_expert_knowledge', type=str, default="original") # original (paper's version), no, minimal, maximal
    ...
    def get_object_from_arguments(args, param_env_bounds, initial_dist=None, target_dist=None):
        ...
        if args.teacher == 'ALP-GMM':
            ...
            if initial_dist is not None and args.allow_expert_knowledge == "maximal":
            ...
            if args.allow_expert_knowledge in ["original", "minimal", "maximal"]:
            ...
            if args.use_pretrained_samples or args.allow_expert_knowledge in ["original", "maximal"]:
