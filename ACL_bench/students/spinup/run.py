import ACL_bench.students
from ACL_bench.students.spinup.user_config import DEFAULT_BACKEND
from ACL_bench.students.spinup.utils.run_utils import ExperimentGrid
...
def parse_and_execute_grid_search(cmd, args):
    ...
    algo = eval('ACL_bench.students.spinup.'+cmd)
