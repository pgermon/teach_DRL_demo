...
import numpy as np
from ACL_bench.students.openai_baselines.common import zipsame
...
def test_runningmeanstd():
    ...
    subprocess.check_call(['mpirun', '-np', '3',
        'python','-c',
        'from ACL_bench.students.openai_baselines.common.mpi_moments import _helper_runningmeanstd; _helper_runningmeanstd()'])
