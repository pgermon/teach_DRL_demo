...
from ACL_bench.students.openai_baselines.common import explained_variance, set_global_seeds
...
try:
    ...
    MPI = None
from ACL_bench.students.openai_baselines.ppo2.synchronous_runner import SynchronousRunner
...
def get_model(network, env, ob_space, ac_space, nbatch_train, nenvs=1, vf_coef=0.5, ent_coef=0.0, model_fn=None,
    ...
    if model_fn is None:
        from ACL_bench.students.openai_baselines.ppo2.model import Model
        model_fn = Model
