...
import pickle
import copy
from ACL_bench.teachers.algos.riac import RIAC
from ACL_bench.teachers.algos.alp_gmm import ALPGMM
from ACL_bench.teachers.algos.covar_gmm import CovarGMM
from ACL_bench.teachers.algos.adr import ADR
from ACL_bench.teachers.algos.self_paced_teacher import SelfPacedTeacher
# from ACL_bench.teachers.algos.truncated_self_paced import SelfPacedTeacher
from ACL_bench.teachers.algos.goal_gan import GoalGAN
from ACL_bench.teachers.algos.setter_solver import SetterSolver
from ACL_bench.teachers.algos.random_teacher import RandomTeacher
from ACL_bench.teachers.algos.oracle_teacher import GaussianOracleTeacher
from ACL_bench.teachers.utils.dimensions_shuffler import DimensionsShuffler
...
class TeacherController(object):
    def __init__(self, teacher, nb_test_episodes, param_env_bounds, seed=None, test_set=None,
        ...
        if test_set is None:
            ...
            test_param_vec = np.array(pickle.load(open("ACL_bench/teachers/test_sets/"+test_set+".pkl", "rb")))
